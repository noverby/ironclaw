...
## [0.19.0](https://github.com/nearai/ironclaw/compare/ironclaw-v0.18.0...ironclaw-v0.19.0) - 2026-03-16

### Added

- add LLM_CHEAP_MODEL for generic smart routing across all backends ([#1081](https://github.com/nearai/ironclaw/pull/1081))
- *(orchestrator)* read ORCHESTRATOR_PORT env var for configurable API port ([#1113](https://github.com/nearai/ironclaw/pull/1113))
- *(transcription)* add Chat Completions API provider for audio transcription ([#1130](https://github.com/nearai/ironclaw/pull/1130))
...
- *(registry)* bump versions for github, web-search, and discord extensions
...
- Fix subagent monitor events being treated as user input ([#1173](https://github.com/nearai/ironclaw/pull/1173))
